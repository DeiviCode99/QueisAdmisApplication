    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etiquetas_pac', models.CharField(choices=[('NUV', 'Cliente Nuevo'), ('ANT', 'Cliente Antiguo'), ('PPN', 'Cliente Pago Pendiente'), ('JOD', 'Cliente Jodido')], default='ANT', max_length=3, null=True)),
                ...
                ('extras', models.JSONField(blank=True, default=list, null=True)),
                ('activo', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('PEND', 'Pendiente'), ('REAL', 'Realizada'), ('CANC', 'Cancelada'), ('RETR', 'Atrasada')], default='PEND', max_length=4)),
